...
export const mockTodaySchedule = [
  ...
  },
  {
    ...
    topik: 'Persamaan Linear & Pola Bilangan',
    ruang: 'Ruang 202',
    status: 'Berikutnya',
    jumlahSiswa: 34,
    kehadiran: '34/34 Hadir',
  },
  {
    id: 3,
    jam: '13.00 - 14.30',
...
export const mockGuruClasses = [
  ...
  },
  {
    ...
    nilaiRata: 82.3,
    status: 'Aktif',
    topikAktif: 'Pola Bilangan & Barisan',
    progressMateri: 70,
  },
  {
    id: 'KLS-8B',
  ...
  },
  {
    ...
    nama: 'Kelas 9A',
    jenjang: 'SMP / Fase D',
    mapel: 'Matematika & TIK',
    jumlahSiswa: 32,
    kehadiranRata: '96.0%',
    nilaiRata: 89.2,
    status: 'Aktif',
    topikAktif: 'Fungsi Kuadrat & Transformasi',
    progressMateri: 85,
  },
];
